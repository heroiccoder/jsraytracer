...
define("Raytracer",["Vec4","Sphere","Color","Canvas","Material","Interseccion", "PointLight", "DirectionalLight", "SpotLight"],function(Vec4, Sphere, Color, Canvas, Material, Interseccion, PointLight, DirectionalLight, SpotLight)
{
