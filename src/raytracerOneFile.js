function Vec4(x=0.0, y=0.0, z=0.0){
	this.x=x;
	this.y=y;
	this.z=z;
	this.w=0.0;	
...
function Material(color_dif=null, color_spec=null, coef_spec=null, coef_ref=null, coef_tr=null, coef_refr=null)
{
	this.color_dif = color_dif;
...
function Interseccion(exists=0, sphere=null, t=null, P=null, N=null, M=null)
{
	this.exists = exists;
	this.sphere = sphere;
	this.t = t;
